...
public class Smelting
{
	public static void init()
	{
		SmeltingRecipes.addSmeltingRecipe("fle:beef", 
				new DiviableFoodSmeltingRecipe(new BaseStack(EnumItem.food_divide_smeltable.instance(1, "beef_raw")), 480000, 450, EnumItem.food_divide_smeltable.instance(1, "beef")));
		SmeltingRecipes.addSmeltingRecipe("fle:chicken", 
				new DiviableFoodSmeltingRecipe(new BaseStack(EnumItem.food_divide_smeltable.instance(1, "chicken_raw")), 480000, 450, EnumItem.food_divide_smeltable.instance(1, "chicken")));
...
//				new SmeltingRecipe(new BaseStack(EnumItem.food_smeltable.instance(1, "fish_raw")), 120000, 450, EnumItem.food_smeltable.instance(1, "fish_kebab")));
		SmeltingRecipes.addSmeltingRecipe("fle:pork", 
				new DiviableFoodSmeltingRecipe(new BaseStack(EnumItem.food_divide_smeltable.instance(1, "pork_raw")), 480000, 450, EnumItem.food_divide_smeltable.instance(1, "pork")));
		SmeltingRecipes.addSmeltingRecipe("fle:squid", 
				new DiviableFoodSmeltingRecipe(new BaseStack(EnumItem.food_divide_smeltable.instance(1, "squid_raw")), 480000, 450, EnumItem.food_divide_smeltable.instance(1, "squid")));
