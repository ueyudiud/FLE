...
public class Configs
{
	...
	{
		NebulaConfiguration.registerTypeAdapter(EntityAttributeTag.class, (arg, field, config, category, name, defValue, comments) -> {
			...
			{
				property = cat.computeIfAbsent("health", key -> new Property(key, Float.toString(attribute.health()), Type.DOUBLE));
			...
			{
				property = cat.computeIfAbsent("followRange", key -> new Property(key, Float.toString(attribute.followRange()), Type.DOUBLE));
			...
			{
				property = cat.computeIfAbsent("speed", key -> new Property(key, Float.toString(attribute.speed()), Type.DOUBLE));
			...
			{
				property = cat.computeIfAbsent("attack", key -> new Property(key, Float.toString(attribute.attack()), Type.DOUBLE));
			...
			{
				property = cat.computeIfAbsent("armor", key -> new Property(key, Float.toString(attribute.armor()), Type.DOUBLE));
