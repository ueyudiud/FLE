...
public class ItemSubCropRelated extends ItemSubEdible
{
	...
	protected void initalize()
	{
		...
		addSubItem(1005, "wild_cabbage_leaf", "Wild Cabbage Leaf", null, new FoodStatBase(0.0F, 0.5F, 1.0F).setAlwaysEdible());
		addSubItem(1006, "cabbage", "Cabbage", null, new FoodStatBase(2.0F, 0.0F, 3.0F).setNutrition(EnumNutrition.VEGETABLE, 4.0F));
		addSubItem(1007, "cauliflower", "Cauliflower", null, new FoodStatBase(2.5F, 0.0F, 1.5F).setNutrition(EnumNutrition.VEGETABLE, 4.0F));
		addSubItem(1008, "purple_cabbage", "Purple Cabbage", null, new FoodStatBase(2.0F, 0.0F, 3.0F).setNutrition(EnumNutrition.VEGETABLE, 5.0F));
		addSubItem(1009, "soybean_pod", "Soybean Pod", null, new FoodStatBase(2.0F, 0.5F, 1.0F).setNutrition(EnumNutrition.VEGETABLE, 1.0F).setNutrition(EnumNutrition.PROTEIN, 2.0F));
		addSubItem(1010, "brussels_sprouts", "Brussels Sprouts", null, new FoodStatBase(2.0F, 0.0F, 2.0F).setNutrition(EnumNutrition.VEGETABLE, 4.0F));
	}
