...
public class TESRDitch extends TESRBase<TEDitch>
{
	...
	public void renderTileEntityAt(TEDitch tile, double x, double y, double z, float partialTicks, int destroyStage)
	{
		...
		if (tank.getFluid() != null)
		{
			...
			float ha = lerp(height0, height1, WEIGHT2), hb = lerp(height0, height2, WEIGHT2), hc = lerp(height0, height3, WEIGHT2), hd = lerp(height0, height4, WEIGHT2),
					...
					y5 = (height0 + height1) * .125F + .25F, y6 = (height0 + height2) * .125F + .25F, y7 = (height0 + height3) * .125F + .25F, y8 = (height0 + height4) * .125F + .25F;
