...
//
// public abstract class FarSurfacableBiome extends BiomeProvider implements
// IBiomeRegetter
// {
...
// temp = temperature;
// hum = humidity;
// biomeTable = HashBasedTable.<Integer, Integer,
// List<BiomeBase>>create(temperature, humidity);
...
// int i = (int) (size * (noiseBiomeBig.noise(x, 0, z) * 0.75 +
// noiseBiomeSmall.noise(x, 0, z) * 0.25));
// return biomes.get(i);
// }
//
// @Override
// public Biome[] getBiomeGenAt(Biome[] listToReuse, int x, int z, int width,
...
// }
//
// if (cacheFlag && width == 16 && length == 16 && (x & 15) == 0 && (z & 15) ==
// 0)
// {
...
//
// @Override
// public BlockPos findBiomePosition(int x, int z, int range, List<Biome>
// biomes, Random random)
// {
// return null;
// }
//
