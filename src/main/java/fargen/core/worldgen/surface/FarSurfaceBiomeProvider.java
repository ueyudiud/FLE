...
//		this.layers = new LayerProp();//Layers.wrapSurface(info.getSeed());
//	}
//
//	@Override
...
//		}
//
//		//		int[] aint = this.layers.biomeLayer2.getInts(x, z, width, length);
...
//		}
//
//		//		int[] aint = this.layers.biomeLayer1.getInts(x, z, width, height);
//
//		try
//		{
...
//			crashreportcategory.addCrashSection("Layer", this.layers.biomeLayer1.toString());
//			crashreportcategory.addCrashSection("x", Integer.valueOf(x));
//			crashreportcategory.addCrashSection("z", Integer.valueOf(z));
