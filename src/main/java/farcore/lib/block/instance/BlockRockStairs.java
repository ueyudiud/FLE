 ...
 * @author ueyudiud
 */
// public class BlockRockStairs extends BlockStairV1 implements
// IThermalCustomBehaviorBlock
// {
...
//
// public BlockRockStairs(int id, BlockRockOld parent, BlockRockStairs[] group,
// String name, Mat material,
// String localName)
// {
...
// LanguageManager.registerLocal(getTranslateNameForItemStack(0), this.localName
// + " Stairs");
// }
//
// @Override
...
// StateMapperExt mapper = new StateMapperStiars(this.material.modid,
// "rock/stairs/" + this.material.name, null, BlockRockOld.HEATED);
