...
// {
// final Function<ItemStack, IBlockState> applier = stack ->
// getStateFromData(stack.getItemDamage());
...
// String.format(type.local, material.localName) + " Slab");
// builder.add(stack);
// switch (type)
// {
// case resource :
...
// ((IDataChecker<IBlockState>) state -> state.getValue(TYPE) ==
// type).from(applier), list);
// break;
// case cobble :
...
// {
// StateMapperExt mapper = new StateMapperExt(FarCore.ID, "rock/slab", MATERIAL,
// HEATED);
// ModelLoader.setCustomStateMapper(this, mapper);
// ModelLoader.setCustomMeshDefinition(this.item,
// stack ->
// mapper.getModelResourceLocation(getStateFromData(stack.getItemDamage())));
// for(Mat material : MATERIAL.getAllowedValues())
// {
// for(EnumRockType type : EnumRockType.values())
// {
// ModelLoader.registerItemVariants(this.item,
// mapper.getModelResourceLocation(EnumBlock.rock_slab.apply(material, type)));
// }
// }
// }
//
...
// {
// return new BlockStateContainer(this, MATERIAL, TYPE, HEATED,
// EnumSlabState.PROPERTY);
// }
//
// @Override
// public void registerStateToRegister(IBlockStateRegister register)
// {
// register.registerStates(this, MATERIAL, TYPE, HEATED,
// EnumSlabState.PROPERTY);
// }
//
// @Override
...
// {
// return state.withProperty(EnumSlabState.PROPERTY,
// EnumSlabState.DOWN).withProperty(MATERIAL, M.stone).withProperty(TYPE,
// EnumRockType.resource).withProperty(HEATED, false);
// }
//
// ItemStack createStackedBlock(Mat material, EnumRockType type)
// {
// // ItemStack stack = new ItemStack(this.item, 1, material.id);
// // ItemStacks.getOrSetupNBT(stack, true).setShort("data", (short)
// type.ordinal());
// // return stack;
// return new ItemStack(this.item, 1, type.ordinal() << 12 |
...
// state = state.withProperty(MATERIAL, MATERIAL.getMaterialFromID(meta & 0xFFF,
// M.stone));
// state = state.withProperty(TYPE, EnumRockType.values()[(meta >> 12) & 0xF]);
// state = state.withProperty(EnumSlabState.PROPERTY,
// EnumSlabState.values()[(meta >> 16) & 0xF]);
...
//
// @Override
// public IBlockState getBlockPlaceState(World worldIn, BlockPos pos, EnumFacing
// facing, float hitX, float hitY,
...
//
// @Override
// public float getBlockHardness(IBlockState blockState, World worldIn, BlockPos
// pos)
// {
// float hardness =
// blockState.getValue(MATERIAL).getProperty(MP.property_rock).hardness *
// blockState.getValue(EnumSlabState.PROPERTY).dropMul * .5F;
...
//
// @Override
// public float getExplosionResistance(World world, BlockPos pos, Entity
// exploder, Explosion explosion)
// {
// return
// world.getBlockState(pos).getValue(MATERIAL).getProperty(MP.property_rock).explosionResistance;
// }
//
// @Override
// public boolean onBurn(World world, BlockPos pos, float burnHardness,
// Direction direction)
// {
// IBlockState state = world.getBlockState(pos);
// if(state.getValue(TYPE).burnable)
// {
// world.setBlockState(pos, state.withProperty(TYPE,
// EnumRockType.values()[state.getValue(TYPE).noMossy]), 3);
// return true;
// }
// return false;
// }
//
// @Override
// public boolean onBurningTick(World world, BlockPos pos, Random rand,
...
//
// @Override
// public int getFireSpreadSpeed(IBlockAccess world, BlockPos pos, EnumFacing
// face)
// {
...
//
// @Override
// public void onHeatChanged(World world, BlockPos pos, Direction direction,
// double amount)
// {
