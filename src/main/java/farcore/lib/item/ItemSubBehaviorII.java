...
import farcore.lib.render.IHookedIconInfo;
...
public class ItemSubBehaviorII<T extends ItemSubBehaviorI> extends ItemSubBehaviorI<T>
{
	...
	public void registerIcons(INamedIconRegister register)
	{
		...
		{
			IconHook.instance.push(iconInfo);
