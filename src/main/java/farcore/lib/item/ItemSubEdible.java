...
public class ItemSubEdible extends ItemSubBehavior implements IFoodStat
{
	...
	public float[] getNutritionAmount(ItemStack stack)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).getNutritionAmount(stack);
		}
		catch (Exception exception)
		{
	...
	public float getDrinkAmount(ItemStack stack)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).getDrinkAmount(stack);
		}
		catch (Exception exception)
		{
			return 0;
	...
	public float getFoodAmount(ItemStack stack)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).getFoodAmount(stack);
		}
		catch (Exception exception)
		{
			return 0;
	...
	public float getSaturation(ItemStack stack)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).getSaturation(stack);
		}
		catch (Exception exception)
		{
			return 0;
	...
	public boolean isEdible(ItemStack stack, EntityPlayer player)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).isEdible(stack, player);
		}
		catch (Exception exception)
		{
			return false;
	...
	public boolean isWolfEdible(ItemStack stack)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).isWolfEdible(stack);
		}
		catch (Exception exception)
		{
			return false;
	...
	public boolean isDrink(ItemStack stack)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).isDrink(stack);
		}
		catch (Exception exception)
		{
			return false;
	...
	public int getEatDuration(ItemStack stack)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).getEatDuration(stack);
		}
		catch (Exception exception)
		{
			return 72000;
	...
	public ItemStack onEat(ItemStack stack, EntityPlayer player)
	{
		try
		{
			return foodstats.get(getBaseDamage(stack)).onEat(stack, player);
		}
		catch (Exception exception)
		{
			return stack;
