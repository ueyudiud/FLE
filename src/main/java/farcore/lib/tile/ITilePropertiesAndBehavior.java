...
public interface ITilePropertiesAndBehavior
{
	...
	{
		float onToolClick(EntityPlayer player, EnumToolType tool, ItemStack stack,
				Direction side, float hitX, float hitY, float hitZ);
		
		float onToolUse(EntityPlayer player, EnumToolType tool, ItemStack stack, long duration,
				Direction side, float hitX, float hitY, float hitZ);
	}
	...
	public static interface ITB_Burn
	{
		...
		void onHeatChange(Direction direction, float amount);
	}
