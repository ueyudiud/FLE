        ...
        else
        {
            ...
            for (int i1 = y + l - 2 - random.nextInt(4); i1 > y + l / 2; i1 -= 2 + random.nextInt(4))
            {
                ...
                for (l1 = 0; l1 < 5; ++l1)
                {
                    ...
                    generateLog(world, j1, i1 - 3 + l1 / 2, k1, 0);
                }
            ...
            {
                if (isReplaceable(world, x, y + l2, z))
                {
                	generateLog(world, x, y + l2, z, 0);
//                    if (l2 > 0)
//                    {
...
//                    }
                ...
                if (l2 < l - 1)
                {
                    if (isReplaceable(world, x + 1, y + l2, z))
                    {
                    	generateLog(world, x + 1, y + l2, z, 0);
//                        if (l2 > 0)
//                        {
...
//                        }
                    ...
                    if (isReplaceable(world, x + 1, y + l2, z + 1))
                    {
                    	generateLog(world, x + 1, y + l2, z + 1, 0);
//                        if (l2 > 0)
//                        {
...
//                        }
                    ...
                    if (isReplaceable(world, x, y + l2, z + 1))
                    {
                    	generateLog(world, x, y + l2, z + 1, 0);
//                        if (l2 > 0)
//                        {
