...
class MatBuilderTest extends Mat.Builder
{
	...
	@Override
	public Builder setBrick(int harvestLevel, float hardness, float resistance) { return setTag(BRICK); }
	
	@Override
	public Builder setCrop(ICrop crop) { return setTag(CROP); }
	
	@Override
	public Builder setOreProperty(int harvestLevel, float hardness, float resistance, IOreProperty oreProperty,
			SubTag type) { return setTag(ORE); }
	
	@Override
	public Builder setMetalic(int harvestLevel, float hardness, float resistance) { return setTag(METAL); }
	
	@Override
	public Builder setHandable(float toughness) { return setTag(HANDLE); }
	
	@Override
	public Builder setPlant(IPlant plant) { return setTag(PLANT); }
	
	@Override
	public Builder setRock(RockBehavior behavior) { return setTag(ROCK); }
	...
	@Override
	public Builder setWood(float woodHardness, float ashcontent, float woodBurnHeat) { return setTag(WOOD); }
}