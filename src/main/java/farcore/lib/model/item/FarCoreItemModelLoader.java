...
public enum FarCoreItemModelLoader implements ICustomModelLoader
{
	...
	static final Function<ItemStack, String> NORMAL_FUNCTION = (ItemStack stack) -> NORMAL;
	static final Function<ItemStack, Integer> NORMAL_MULTIPLIER = (ItemStack stack) -> 0xFFFFFFFF;
