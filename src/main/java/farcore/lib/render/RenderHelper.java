...
public class RenderHelper
{
	...
	{
		this.buffer.pos(x, y, z).color(r, g, b, a);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.pos(x, y, z).color((rgba >> 24) & 0xFF, (rgba >> 16) & 0xFF, (rgba >> 8) & 0xFF, rgba & 0xFF);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.pos(x, y, z).tex(u, v).color(r, g, b, a);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.pos(x, y, z).tex(u, v).color((rgba >> 24) & 0xFF, (rgba >> 16) & 0xFF, (rgba >> 8) & 0xFF, rgba & 0xFF);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.pos(x, y, z).tex(u, v).lightmap(skylight, blocklight).color((rgba >> 24) & 0xFF, (rgba >> 16) & 0xFF, (rgba >> 8) & 0xFF, rgba & 0xFF);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.pos(x, y, z).tex(u, v).lightmap(light >> 16 & 0xFF, light & 0xFF).color(r, g, b, a);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.pos(x, y, z).tex(u, v).lightmap(light >> 16 & 0xFF, light & 0xFF).color((rgba >> 24) & 0xFF, (rgba >> 16) & 0xFF, (rgba >> 8) & 0xFF, rgba & 0xFF);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
	...
	{
		this.buffer.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX_COLOR);
		vertex(x1, y1, z1, u1, v1, r, g, b, a);
		vertex(x2, y2, z2, u2, v2, r, g, b, a);
		vertex(x3, y3, z3, u3, v3, r, g, b, a);
		vertex(x4, y4, z4, u4, v4, r, g, b, a);
		this.buffer.endVertex();
		return this;
	}
	...
	{
		this.buffer.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX_LMAP_COLOR);
