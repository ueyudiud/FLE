...
public class MC
{
	...
	public static final MatCondition brickBlock = new MatCondition("brick_block", "brickBlock", "Brick", "%s Brick").setSize(5184L, 1296L, 1.5F).setFilter(SubTag.ROCK);
	...
	public static final MatCondition chip_ore = new MatCondition("chip_ore", "chip", "Ore Chip", "%s Chip").setSize(576L, 576L, 4.0F).setFilter(SubTag.ORE);
	...
	public static final MatCondition plankBlock = new MatCondition("plank_block", "plank", "Plank", "%s Plank").setSize(1296L).setFilter(SubTag.WOOD);
	...
	public static final MatCondition crop = new MatCondition("crop", "Crop", "%s").setUnsizable().setFilter(SubTag.CROP);
	...
	public static final MatCondition adz_metal = new MatCondition("adz_metal", "adz", "Adz", "%s Adz").setSize(288L, 288L, 1.2F).setFilter(new IDataChecker.And(SubTag.METAL, SubTag.TOOL));
	public static final MatCondition adz_rock = new MatCondition("adz_rock", "adz", "Adz", "%s Adz").setSize(288L, 288L, 1.2F).setFilter(new IDataChecker.And(new IDataChecker.Or(SubTag.ROCK, SubTag.FLINT), SubTag.TOOL));
	...
	public static final MatCondition shovel_rock = new MatCondition("shovel_rock", "shovel", "Shovel", "%s Shovel").setSize(288L, 288L, 1.2F).setFilter(new IDataChecker.And(new IDataChecker.Or(SubTag.ROCK, SubTag.FLINT), SubTag.TOOL));
	public static final MatCondition shovel_metal = new MatCondition("shovel_metal", "shovel", "Shovel", "%s Shovel").setSize(144L, 144L, 1.2F).setFilter(new IDataChecker.And(SubTag.METAL, SubTag.TOOL));
	
	public static final MatCondition spade_hoe_rock = new MatCondition("spade_hoe.rock", "spadeHoe", "Spade-Hoe", "%s Spade-Hoe").setSize(288L, 288L, 1.3F).setFilter(new IDataChecker.And(SubTag.ROCK, SubTag.TOOL));
	
	public static final MatCondition spear_rock = new MatCondition("spear_rock", "spear", "Spear", "%s Spear").setSize(288L, 288L, 1.2F).setFilter(new IDataChecker.And(SubTag.ROCK, SubTag.TOOL));
	
	public static final MatCondition sickle_rock = new MatCondition("sickle_rock", "sickle", "Sickle", "%s Sickle").setSize(288L, 288L, 1.0F).setFilter(new IDataChecker.And(SubTag.ROCK, SubTag.TOOL));
