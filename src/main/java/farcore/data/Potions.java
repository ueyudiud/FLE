...
public class Potions
{
	...
	public static final Potion BLEED = new MobEffectBleeding("bleeding", 0xC63429, 30, 2.0F);
	public static final Potion INFECT_ZV = new MobEffectBleeding("infect_zv", 0x3E872D, 24, 1.5F);
