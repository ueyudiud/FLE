...
public class Materials
{
	...
	/** Metal material, it is just {@link net.minecraft.block.material.Material#IRON}. */
	public static final Material METALIC = Material.IRON;
	/** Tree log material, different from {@link net.minecraft.block.material.Material#WOOD}, this one is tool-required. */
	...
	/** Ice material, different from {@link net.minecraft.block.material.Material#ICE}, this one is tool-required. */
