...
public class M
{
	...
	// public static final Mat white_sand = new Mat(7203, FarCore.ID ,
	// "white_sand" , "WhiteSand" , "White Sand"
	// ).builder().setRGBa(0xE8DCB1FF).setSand(0.8F, 1.4F).build();
	// public static final Mat salty_sand = new Mat(7204, FarCore.ID ,
	// "salty_sand" , "SaltySand" , "Salty Sand"
	// ).builder().setRGBa(0xE8DCB1FF).setSand(0.8F, 1.2F).build();
	// Clay
	...
	public static void init()
	{
		for (Runnable register : MATERIAL_REGISTERS)
		{
			...
			{
				Log.warn("Caught an exception during {} is registering materials, " + "this exception might not cause by Far Core, please report " + "this execpion to creator.", register.toString());
				throw exception;
			}
		}
	}
