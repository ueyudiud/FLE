...
public class M
{
	...
	public static final Mat brown_sandstone		= new MaterialBuilder(7020, FarCore.ID , "brown_sandstone"		, "BrownSandstone"		, "Brown Sandstone"		).setRGBa(0xAF7D54FF)                                                .build().setRock( 3, 2.0F,  5.7F);
	public static final Mat chalk				= new MaterialBuilder(7021, FarCore.ID , "chalk"				, "Chalk"				, "Chalk"				).setRGBa(0xE9EAEAFF)                                                .build().setRock( 4, 2.4F,  6.6F);
	public static final Mat chert				= new MaterialBuilder(7022, FarCore.ID , "chert"				, "Chert"				, "Chert"				).setRGBa(0x7F7D7CFF)                                                .build().setRock( 5, 2.4F,  6.4F);
	public static final Mat conglomerate		= new MaterialBuilder(7023, FarCore.ID , "conglomerate"			, "Conglomerate"		, "Conglomerate"		).setRGBa(0xB0ADA2FF)                                                .build().setRock( 6, 2.4F,  6.3F);
	public static final Mat dolostone			= new MaterialBuilder(7024, FarCore.ID , "dolostone"			, "Dolostone"			, "Dolostone"			).setRGBa(0xA39C97FF)                                                .build().setRock( 6, 2.4F,  6.3F);
	public static final Mat ocherous_sandstone	= new MaterialBuilder(7025, FarCore.ID , "ocherous_sandstone"	, "OcherousSandstone"	, "Ocherous Sandstone"	).setRGBa(0xAD906AFF)                                                .build().setRock( 3, 2.0F,  5.6F);
