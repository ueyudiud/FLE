...
implements IShearable
{
	...
	protected BlockLeaves(BlockLog log, SubstanceWood wood, String name, Material material)
	{
		super(EnumBlockType.leaves, name, material);
		this.log = log;
		this.wood = wood;
		setHardness(0.5F);
		setResistance(0.02F);
	}
	protected BlockLeaves(BlockLog log, SubstanceWood wood, String name, Class<? extends ItemBlockBase> clazz, Material material,
			Object[] objects)
	{
		super(EnumBlockType.leaves, name, clazz, material, objects);
		this.log = log;
		this.wood = wood;
		setHardness(0.5F);
		setResistance(0.02F);
	...
	{
		register.registerIcon("simple", getTextureName() + "_opaque");
		register.registerIcon("adv", getTextureName());
	}
