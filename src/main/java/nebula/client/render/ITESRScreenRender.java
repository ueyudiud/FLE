...
/**
 * Use for rendering with screen, for used for projector to project screen to
 * other place.
 * 
 * @author ueyudiud
 */
...
{
	/**
	 * Render screen to world.
	 * <p>
	 * The (0, 0, 0) postion is at left down side of screen.
	 * 
	 * @param tile the render tile enenty.
	 * @param lineScale the line scale, for consider with viewer distance and
