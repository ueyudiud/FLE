...
{
	@SideOnly(Side.CLIENT)
	public static enum Factory implements IRenderFactory<EntityFallingBlockExtended>
	{
		instance;
		
		@Override
		public Render<EntityFallingBlockExtended> createRenderFor(RenderManager manager)
		{
