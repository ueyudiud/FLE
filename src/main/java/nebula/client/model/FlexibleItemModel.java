...
public class FlexibleItemModel implements IPerspectiveAwareModel, ICustomItemRenderModel
{
	private Function<ItemStack, List<BakedQuad>>[] layers;
	private TextureAtlasSprite particle;
	
	public FlexibleItemModel(Function<ItemStack, List<BakedQuad>>[] layers, TextureAtlasSprite particle)
	{
		this.layers = layers;
