...
public class BaseStack implements AbstractStack
{
	...
	public BaseStack(String modid, String name, int size, int meta, boolean useContainer)
	{
		...
		useContainer = false;
		this.isWildcardValue = item != null && (item.getHasSubtypes() && meta == OreDictionary.WILDCARD_VALUE);
	}
	...
	public BaseStack(ItemStack stack, int size)
	{
		...
		this.isWildcardValue = stack != null && stack.getHasSubtypes() && stack.getItemDamage() == OreDictionary.WILDCARD_VALUE;
	}
	public BaseStack(ItemStack stack, int size, int meta)
	{
		...
		this.isWildcardValue = stack != null && stack.getHasSubtypes() && meta == OreDictionary.WILDCARD_VALUE;
	}
