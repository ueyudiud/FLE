...
/**
 * Block state register, use to register network data.
 * <p>
 * The <tt>id</tt> of block state will allocate autonomously, you only need
 * assigning which state can be ignored or merge to other state to store.
 * 
 * @author ueyudiud
 */
public interface IBlockStateRegister
{
	 ...
	 * Example:
	 * <p>
	 * <tt>block[facing={n, s}, type={1, 2}];</tt>
	 * <p>
	 * <code>registerStates(PROPERTY_FACING);</code> will put:
	 * <p>
	 * [block{facing=n, type=1}, block{facing=n, type=2}]=>id1<br>
	 * [block{facing=s, type=1}, block{facing=s, type=2}]=>id2
	 * <p>
	 * to map.
	 * 
	...
	/**
	 * Register <tt>id=>source</tt> and <tt>targets=>id</tt> logic.
	 * <p>
	 * 
