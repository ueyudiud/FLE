...
/**
 * The custom falling block event handler.
 * <p>
 * Use to handle the <tt>falling</tt> event which falling block contains the
 * block implements this interface.
 * <p>
 ...
 * the static falling handler instead.
 * 
 * @author ueyudiud
...
{
	/**
	 * Called when entity spawning in world, and block are already started
	 * falling (the source block is already removed from world).
	 * 
	...
	/**
	 * Check can falling block stay at checking position.
	 * <p>
	 * Return <code>true</code> the block will began start <tt>stay</tt> action
	 * at this position in world.
	 * 
	 * @param world the world.
	 * @param pos the position.
	 * @param state the falling block state.
	 * @return <code>true</code> if block can stay at position, and
	...
	/**
	 * Called when <tt>stay</tt> action start.
	 * <p>
	 * The block will try to fallen on the ground, you may use this method to
	 * canceled the vanilla falling block replace <tt>behavior</tt> and use your
	 * custom replace behavior instead. If do it, return <code>true</code> to
	 * cancel vanilla <tt>replace</tt> behavior.
	 * 
	 * @param world the world.
	 * @param pos the position the entity fallen at.
	 * @param state the block state.
	 * @param height the height the entity block fallen from world.
	 * @param tileNBT the cached tile NBT, which loaded from source tile before
	 *            falling block fallen.
	 * @return return <code>true</code> to cancel vanilla <tt>replace</tt>
	 *         behavior, or <code>false</code> to handle by vanilla
	 *         <tt>replace</tt> behavior.
	 */
