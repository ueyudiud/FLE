...
import flapi.cg.IGuideType.IGuidePage.Type;
...
public abstract class IGuideType
{
	...
	final List<IGuidePage> a(GuideTransInfo info)
	{
		...
		{
			return getPage((AbstractStack) info.contain[0]);
		}
		...
		{
			return getPage(((SolidStack) info.contain[0]).get());
		}
		return getPage(info);
	}
	...
	protected List<IGuidePage> getPage(AbstractStack contain)
	{
	...
	public static abstract class IGuidePage
	{
		...
		public abstract int getSize(Type type);
		public abstract Object getObject(Type type, int index);
		public abstract Object getObjectForDisplay(Type type, int index);
		public abstract Rectangle getRectangle(Type type, int index);
		public abstract String getStackTip(Type type, int index);
		public abstract List<String> getToolTip(Type type, int index);
