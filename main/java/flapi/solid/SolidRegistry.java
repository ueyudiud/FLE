...
public class SolidRegistry
{
    ...
    public static boolean registerSolidContainer(SolidContainerData data)
    {
        ...
        if (data.contain == null || data.contain.get() == null)
        {
    ...
    public static ItemStack fillSolidContainer(SolidStack solid, ItemStack container)
    {
        ...
        if (data != null && solid.size() >= data.contain.size())
        {
	...
	public static int getSolidID(Solid solid)
	{
		return register.serial(solid);
	}
	
	public static Solid getSolidFromID(int id)
	{
	...
	private static class ContainerKey
	{
		...
		public int hashCode()
		{
			...
			if(stack != null)
				code = code * 31 + stack.get().hashCode();
			return code;
		}
