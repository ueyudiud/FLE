...
public interface IMultiTankPart
{
	 ...
	 */
	boolean canBeConnect(TEAbstractTank main, int xPos, int yPos, int zPos, int width, int height);
	 ...
	 * @return Can this tile be a part in a new tank.
	 */
	boolean canBeConnect(TEAbstractTank main);
	 ...
	 * @param height
	 */
	void onConnect(TEAbstractTank main, int xPos, int yPos, int zPos, int width, int height);
	 ...
	 */
	void onDisconnect(TEAbstractTank main);
}