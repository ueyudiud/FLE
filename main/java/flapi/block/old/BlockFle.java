...
//import flapi.FleAPI;
//import flapi.cover.CoverTile;
//import flapi.cover.ICoverTE;
...
//				{
//					CoverTile cover = ((ICoverTE) tile).getCover(dir);
//					if(cover != null)
//					{
//						cover.onBlockBreak();
//					}
...
//		{
//			CoverTile tile = ((ICoverTE) aWorld.getTileEntity(x, y, z)).getCover(ForgeDirection.VALID_DIRECTIONS[aSide]);
//			if(tile != null)
//				return tile.onBlockActive(aPlayer, xPos, yPos, zPos);
//		}
