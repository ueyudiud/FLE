...
public class Substance implements ISubTagContainer
{
	...
	/**
	 * Twist Strength of the solid; negative values are not permissible.<br>
	 *
	 * To get how hardness to twist this material.<br>
	 *
	 * Higher shear strength means that material can cut hardly, like tungsten.
	 * Lower shear strength means that material can cut easily, like lithium.
	 * 
	 * The default value is 1000kPa (Unit : kPa).
	 */
	public long twistStrength = 1000;
	/**
	 ...
	 * temperature, like water. Lower viscosity means that a matter will contain
	 * less heat in high temperature, like stone.
	 */
	public long specificHeat = 4200;
	...
	public short[][] color = {
			...
			{255, 255, 255, 255}, {255, 255, 255, 255}, {255, 255, 255, 255},
			{255, 255, 255, 255}};
	private final EnumMap<Phase, Substance> phaseMap = new EnumMap(Phase.class);
	...
	{
		FleAPI.lang.registerLocal(getTranslateName(), localized);
		return this;
	}
	
	public Substance setTranslate(String locale, String localized)
	{
		FleAPI.lang.registerLocal(locale, getTranslateName(), localized);
		return this;
	}
	...
	public Substance getSubstance(Phase phase)
	{
		return phaseMap.containsKey(phase) ? phaseMap.get(phase) : this;
	}
	
	public Phase getPhase(IPhaseCondition condition)
	{
		return phasePhaseDiagram.getPhase(condition);
	}
