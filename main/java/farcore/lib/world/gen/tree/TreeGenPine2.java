...
public class TreeGenPine2 extends TreeGenAbstract
{
	@Override
            ...
            else
            {
                ...
                if (isSoil && y < 256 - l - 1)
                {
                    ...
                    for (i4 = 0; i4 <= j1; ++i4)
                    {
                        ...
                        for (int l2 = x - l3; l2 <= x + l3; ++l2)
                        {
                            ...
                            for (int j3 = z - l3; j3 <= z + l3; ++j3)
                            {
                                ...
                                {
                                    this.setBlockAndNotifyAdequately(world, l2, k2, j3, leaves, 0);
                                }
                            }
                        }
                    ...
                    for (k2 = 0; k2 < l - i4; ++k2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(world, x, y + k2, z, log, 0);
                        }
                    }
