...
public class TESRPlacedItem extends TESRBase<TileEntityPlacedItem>
{
	@Override
	public void renderTileEntityAt(TileEntityPlacedItem tile, double xPos,
			double yPos, double zPos)
	{
		...
		if(tile.getStack() != null)
		{
			...
			ItemStack target = tile.getStack().copy();
