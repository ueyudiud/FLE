...
public class IBF
{
	...
	{
		Fluids1.water = new FluidWater("water").setSubstance(Substance2.water).setTemperature(water_freeze_point + 25);
		Fluids1.saltyWater = new FluidWater("salty_water").setSubstance(Substance2.saltyWater).setTemperature(water_freeze_point + 25);
		
		Blocks1.rock = new BlockRock("rock");
		Blocks1.rock.setLocalizedName("rock").setCreativeTab(CreativeTabs.tabBlock);
		Blocks1.mineral = new BlockMineral("mineral");
		Blocks1.mineral.setLocalizedName("mineral").setCreativeTab(CreativeTabs.tabBlock);
		Blocks1.sand = new BlockSand("sand");
		Blocks1.sand.setLocalizedName("sand").setCreativeTab(CreativeTabs.tabBlock);
		Blocks1.dirt = new BlockDirt("dirt");
		Blocks1.dirt.setLocalizedName("dirt").setCreativeTab(CreativeTabs.tabBlock);
		new ItemDebug().setMaxStackSize(1).setCreativeTab(CreativeTabs.tabRedstone);
	}
