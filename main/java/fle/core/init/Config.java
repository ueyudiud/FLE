...
import static fle.core.handler.FuelHandler.p;
...
public class Config
{
	...
	{
		configMap.put("pCharcoal", setInteger(config, "energy", "Charcoal Power", "High value will make charcoal heating faster.", p()));
		configMap.put("pFirewood", setInteger(config, "energy", "Firewood Power", "High value will make firewood heating faster.", p(0.8F)));
		configMap.put("pLavaTransfer", setInteger(config, "energy", "Lava Heat Transfer Power", "High value will make lava heat transfer heating faster.", p()));
		configMap.put("pCeramicFirebox", setInteger(config, "energy", "Ceramic Firebox Power", "High value will make cermaic firebox heating faster.", p(1.25F)));
		configMap.put("pBoilingHeater", setInteger(config, "energy", "Boiling Heater Power", "High value will make boiling heater heating faster.", p()));

		configMap.put("pItemSmeltingTick", setInteger(config, "energy", "Item Smelting Pre Size", "You need energy with this value to smelting items.", g()));
