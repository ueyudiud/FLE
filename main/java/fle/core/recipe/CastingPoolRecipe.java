...
public class CastingPoolRecipe implements IFreezingRecipe
{
	public static void init()
	{
		...
		MatterDictionary.registerMatter(new CastingPoolRecipe(new FluidStack(IB.cu_as_0, FleValue.ingot_mol * 3 * 3), "  x xxxxx", ItemToolHead.a("metal_axe", Materials.CuAs, 7)));
		...
		MatterDictionary.registerMatter(new CastingPoolRecipe(new FluidStack(IB.cu_as_0, FleValue.ingot_mol * 3 * 3), "   xxxxxx", ItemToolHead.a("metal_pickaxe", Materials.CuAs, 7)));
		...
		MatterDictionary.registerMatter(new CastingPoolRecipe(new FluidStack(IB.cu_as_0, FleValue.ingot_mol * 3 * 1), "x xxxxxxx", ItemToolHead.a("metal_shovel", Materials.CuAs, 7)));
		...
		MatterDictionary.registerMatter(new CastingPoolRecipe(new FluidStack(IB.cu_as_0, FleValue.ingot_mol * 3 * 5), "     xxxx", ItemToolHead.a("metal_hammer", Materials.CuAs, 7)));
		...
		MatterDictionary.registerMatter(new CastingPoolRecipe(new FluidStack(IB.cu_as_0, FleValue.ingot_mol * 3 * 5), "   x  xxx", ItemToolHead.a("metal_hammer", Materials.CuAs, 7)));
		...
		MatterDictionary.registerMatter(new CastingPoolRecipe(new FluidStack(IB.cu_as_0, FleValue.ingot_mol * 3 * 2), " xxx xxxx", ItemToolHead.a("metal_chisel", Materials.CuAs, 7)));
		...
		MatterDictionary.registerMatter(new CastingPoolRecipe(new FluidStack(IB.cu_as_0, FleValue.ingot_mol * 3 * 2), "xx x xxxx", ItemToolHead.a("metal_chisel", Materials.CuAs, 7)));
