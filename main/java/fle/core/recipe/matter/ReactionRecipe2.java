...
public class ReactionRecipe2
{
	...
	{
		//SnO2 + C = Sn + CO2
		addRecipe(Atoms.C, Matter.mSnO2, 792, EnumOxide.Lowest, EnumOxide.Br2, 0.000174, 0.002481, 0.00947591, 
				new Stack(Atoms.Sn.asMatter()), new Stack(Matter.mCO2));
		...
		//PbO + C = Pb + CO
		addRecipe(Atoms.C, Matter.mPbO, 592, EnumOxide.Lowest, EnumOxide.Br2, 0.0001291, 0.005175, 0.01247591, 
				new Stack(Atoms.Pb.asMatter()), new Stack(Matter.mCO));
		//PbO + CO = Pb + CO2
		addRecipe(Matter.mCO, Matter.mPbO, 592, EnumOxide.Lowest, EnumOxide.Br2, 0.0001141, 0.004175, 0.01247591, 
				new Stack(Atoms.Pb.asMatter()), new Stack(Matter.mCO2));
	}
	
	public static void addFeGroupRecipe()
	{
		//Fe2O3 + C = 2FeO + CO
		addRecipe(Atoms.C, Matter.mFe2O3, 1048, EnumOxide.Lowest, EnumOxide.Br2, 0.0001341, 0.001175, 0.00126581, 
				new Stack(Matter.mFeO, 2), new Stack(Matter.mCO));
		//Fe3O4 + C = 3FeO + CO
		addRecipe(Atoms.C, Matter.mFe3O4, 1019, EnumOxide.Lowest, EnumOxide.Br2, 0.0001541, 0.001175, 0.00129481, 
		...
		addRecipe(Matter.mFeO, Matter.mO2, 719, EnumOxide.Default, EnumOxide.Highest, 0.0000741, 0.00175, 0.00099481, 
				new Stack(Ions.Ferricoxide.asMatter()), new Stack(Atoms.O.asMatter()), new Stack(Ions.O_1.asMatter()));
		//FeO + O- = FeO+ + O2-
		addRecipe(Matter.mFeO, Ions.O_1.asMatter(), 719, EnumOxide.Default, EnumOxide.Highest, 0.0000741, 0.00175, 0.010481, 
				new Stack(Ions.Ferricoxide.asMatter()), new Stack(Ions.O_2.asMatter()));
		//2FeO+ + O2- = Fe2O3
		addRecipe(Matter.mFeO, 2, Ions.O_1.asMatter(), 1, 719, EnumOxide.Default, EnumOxide.Highest, 0.0001279, 0.00175, 0.007481, 
				new Stack(Matter.mFe2O3));
		//FeO + CO = Fe + CO2
		addRecipe(Matter.mFeO, Matter.mCO, 1017, EnumOxide.Mg, EnumOxide.C, 0.0002279, 0.00391, 0.0001481, 
				new Stack(Atoms.Fe), new Stack(Matter.mCO2));
		//FeO + C = Fe + CO
		addRecipe(Atoms.C, Matter.mFeO, 1047, EnumOxide.Mg, EnumOxide.C, 0.0002038, 0.00391, 0.0001385, 
				new Stack(Atoms.Fe), new Stack(Matter.mCO));
		//FeS + O2 = FeO + SO
	...
	{
		//CuO + C = Cu + CO
		addRecipe(Atoms.C, Matter.mCuO, 771, EnumOxide.S, EnumOxide.Mg, 0.0000018, 0.00181, 0.010491, 
				new Stack(Atoms.Cu.asMatter()), new Stack(Matter.mCO));
		//CuO + CO = Cu + CO2
		addRecipe(Matter.mCO, Matter.mCuO, 771, EnumOxide.S, EnumOxide.Mg, 0.0000024, 0.00172, 0.010491, 
				new Stack(Atoms.Cu.asMatter()), new Stack(Matter.mCO2));
		//Cu2O + O = 2CuO
		addRecipe(Atoms.O, Matter.mCu2O, 791, EnumOxide.Highest, EnumOxide.C, 0.000196, 0.0022, 0.000987, 
				new Stack(Matter.mCuO, 2));
		//Cu2O + C = 2Cu + CO
		addRecipe(Atoms.C, Matter.mCu2O, 771, EnumOxide.S, EnumOxide.Mg, 0.0000024, 0.00185, 0.011841, 
				new Stack(Atoms.Cu.asMatter(), 2), new Stack(Matter.mCO));
		//Cu2O + CO = 2Cu + CO2
		addRecipe(Matter.mCO, Matter.mCu2O, 771, EnumOxide.S, EnumOxide.Mg, 0.0000028, 0.00187, 0.011849, 
				new Stack(Atoms.Cu.asMatter(), 2), new Stack(Matter.mCO2));
		...
		//CuS + O = CuO + S
		addRecipe(Atoms.O, Matter.mCuS, 641, EnumOxide.O2, EnumOxide.Default, 0.0001349, 0.001018, 0.010438, 
				new Stack(Matter.mCuO), new Stack(Atoms.S.asMatter()));
		//Cu2S + O = Cu2O + S
		addRecipe(Atoms.O, Matter.mCu2S, 641, EnumOxide.O2, EnumOxide.Default, 0.0001349, 0.001018, 0.010438, 
				new Stack(Matter.mCu2O), new Stack(Atoms.S.asMatter()));
		//CuCO3 = CuO + CO2
