...
public class OreMeltingRecipe
{
	...
	static
	{
		...
		registerRecipe(new OreMeltingRecipe(Materials.Chalcocite, 450, 180000, Materials.Cuprite, 0.9F));
		registerRecipe(new OreMeltingRecipe(Materials.Covellite, 500, 102000, Materials.Tenorite, 0.95F));
		registerRecipe(new OreMeltingRecipe(Materials.Malachite, 400, 86000, Materials.Tenorite, 0.2F));
	}
