...
import fle.core.item.behavior.tool.BehaviorArrow;
import fle.core.item.behavior.tool.BehaviorAwl;
import fle.core.item.behavior.tool.BehaviorAxe;
import fle.core.item.behavior.tool.BehaviorBowsaw;
import fle.core.item.behavior.tool.BehaviorChisel;
import fle.core.item.behavior.tool.BehaviorFirestarter;
import fle.core.item.behavior.tool.BehaviorHoe;
import fle.core.item.behavior.tool.BehaviorKnife;
import fle.core.item.behavior.tool.BehaviorPickaxe;
import fle.core.item.behavior.tool.BehaviorShovel;
import fle.core.item.behavior.tool.BehaviorStoneHammer;
import fle.core.item.behavior.tool.BehaviorTool;
import fle.core.item.behavior.tool.BehaviorWhetstone;
import fle.core.item.behavior.tool.BehaviorWoodHammer;
