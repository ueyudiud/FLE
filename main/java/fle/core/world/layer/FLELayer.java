...
{	
	public static GenLayer[] initializeAllBiomeGenerators(long seed, WorldType type)
    {
        if(type == FLEWorldType.FLAT)
        {
        	...
        	FLELayerFloor gen2 = new FLELayerFloor(new NoiseSmooth(4D, new NoisePerlin(1001L, 2)), new NoiseSmooth(4D, new NoisePerlin(1003L, 2)), gen0, 10L);
            drawImage(512, gen2, "1 ContinentsFloor");
        	FLELayerItrZoom gen1 = new FLELayerItrZoom(8, 29L, gen2);
        	...
        	gen1 = new FLELayerItrZoom(2, seed, gen3);
        ...
        FLELayerItrZoom gen3 = new FLELayerItrZoom(1, 255L, gen2);
        drawImage(512, gen3, "7 ContinentsZoom");
        FLELayerMontain gen6 = new FLELayerMontain(4L, gen3, new NoiseSmooth(32D, new NoisePerlin(1L, 2)));
        ...
        FLELayerFloor gen4;
        gen4 = new FLELayerFloor(new NoiseSmooth(87D, new NoisePerlin(0L, 2)), new NoiseSmooth(83D, new NoisePerlin(0L, 2)), gen1, 10L);
        ...
        FLELayerItrZoom gen10 = new FLELayerItrZoom(1, 294L, gen7);
			...
			WorldType type)
	{
        if(type == FLEWorldType.FLAT)
        {
        	FLELayerNetherFloor gen2 = new FLELayerNetherFloor(new NoiseSmooth(4D, new NoisePerlin(1001L, 2)), new NoiseSmooth(4D, new NoisePerlin(1003L, 2)), 10L);
        ...
        GenLayerZoom gen1;
        FLELayerItrZoom gen3;
        FLELayerNetherFloor gen4;
        gen4 = new FLELayerNetherFloor(new NoiseSmooth(87D, new NoisePerlin(1001L, 2)), new NoiseSmooth(83D, new NoisePerlin(1003L, 2)), 10L);
        ...
        gen1 = new GenLayerZoom(2L, gen5);
        drawImage(512, gen1, "4 ContinentsZoom");
        gen3 = new FLELayerItrZoom(1, 2L, gen1);
        ...
        if(type == FLEWorldType.LARGE_BIOMES)
        {
        	gen3 = new FLELayerItrZoom(6, 294L, gen13);
        	gen13 = new GenLayerSmooth(284L, gen3);
        	GenLayerVoronoiZoom gen12 = new GenLayerVoronoiZoom(10L, gen13);
            gen12.initWorldGenSeed(seed);
            gen13.initWorldGenSeed(seed);
