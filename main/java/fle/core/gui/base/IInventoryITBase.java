...
public abstract class IInventoryITBase<T extends TileEntity> extends InventoryTileBase<T> implements IFluidHandler
{
	private final FleFluidTank[] tanks;

	public IInventoryITBase(int aSize, int aCapacity)
	{
		super(aSize);
		tanks = new FleFluidTank[]{new FleFluidTank(aCapacity)};
	}
	public IInventoryITBase(int aSize, Fluid targetFluid, int aCapacity)
	{
		super(aSize);
		tanks = new FleFluidTank[]{new FleFluidTank(targetFluid, aCapacity)};
	}
	public IInventoryITBase(int aSize, FleFluidTank...aTanks)
	{
		super(aSize);
		tanks = aTanks;
	}
