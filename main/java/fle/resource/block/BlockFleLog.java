...
public class BlockFleLog extends BlockFle implements IFacingBlock, IDebugableBlock
{
	...
	public BlockFleLog(TreeInfo aInfo)
	{
		...
		FleAPI.langManager.registerLocal(new ItemStack(this).getUnlocalizedName(), Character.toString(s.charAt(0)).toUpperCase() + s.substring(1) + " Log");
	}
    ...
    {
    	return info.onLogToss(aWorld, x, y, z, aPlayer, aPlayer.getCurrentEquippedItem());
    }
