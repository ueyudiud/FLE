...
import fle.api.recipe.machine.PolishRecipe.IPolishableTool;
import fle.api.recipe.machine.PolishRecipe.PolishCondition;
import fle.api.recipe.machine.PolishRecipe.PolishTool;
...
public class Polishing 
{
	...
	{
		new PolishCondition("polish", "Polish", 'p').setTextureName("polish");
		new PolishCondition("crush", "Crush", 'c').setTextureName("crush");
