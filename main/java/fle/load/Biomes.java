...
public class Biomes
{
	...
	public static void init()
	{
		...
		EnumBiome.forest_deciduous_hill.setBiome(		new BiomeForest(55, 1).setColor(0x056621).setTemperatureRainfall(0.7F, 0.8F).setHeight(height_LowHills));
		EnumBiome.grass_hill.setBiome(					new BiomePlain(56).setColor(0x8DB360).setTemperatureRainfall(0.8F, 0.4F).setHeight(height_LowHills));
		EnumBiome.forest_coniferous_hill.setBiome(		new BiomeTaiga(57, 0).setColor(0x596651).setTemperatureRainfall(0.4F, 0.5F).setHeight(height_LowHills));
		EnumBiome.tundra_hill.setBiome(					new BiomeTundra(58).setColor(0xD5D6D1).setDisableRain().setTemperatureRainfall(0.05F, 0.02F).setHeight(height_LowHills));
		EnumBiome.forest_coniferous_snowy_hill.setBiome(new BiomeTaiga(59, 0).setColor(0x243F36).setEnableSnow().setTemperatureRainfall(0.2F, 0.3F).setHeight(height_LowHills));
		EnumBiome.mountain_snowy.setBiome(				new BiomeMountain(60, false, false).setColor(0x606060).setEnableSnow().setTemperatureRainfall(-0.5F, 0.4F).setHeight(height_HighHills));
		EnumBiome.mountain_deciduous_forest.setBiome(	new BiomeMountain(61, true, true).setColor(0x609860).setTemperatureRainfall(0.3F, 0.4F).setHeight(height_MidHills));
		EnumBiome.mountain_meadow.setBiome(				new BiomeMountain(62, false, true).setColor(0x607260).setTemperatureRainfall(0.2F, 0.4F).setHeight(height_MidHills));
		EnumBiome.mountain_frigid.setBiome(				new BiomeMountain(63, false, false).setColor(0x707070).setEnableSnow().setTemperatureRainfall(-0.2F, 0.4F).setHeight(height_MidHills));
		EnumBiome.volcanic_island.setBiome(				new BiomeIsland(64, Blocks.obsidian, true).setColor(0x34343F).setTemperatureRainfall(0.9F, 0.6F).setHeight(height_LowIslands));
		EnumBiome.tropic_island.setBiome(				new BiomeIsland(65, Blocks.grass, true).setColor(0x11950C).setTemperatureRainfall(1.2F, 0.9F).setHeight(height_LowIslands));
		EnumBiome.savanna_plateau.setBiome(				new BiomeSavanna(66).setColor(0xBDB25F).setDisableRain().setTemperatureRainfall(1.3F, 0.2F).setHeight(height_Plateau));
		EnumBiome.forest_plateau.setBiome(				new BiomeTaiga(67, 1).setColor(0x596651).setTemperatureRainfall(0.4F, 0.3F).setHeight(height_Plateau));
		EnumBiome.grassland_plateau.setBiome(			new BiomePlain(68).setColor(0x9EB287).setTemperatureRainfall(0.7F, 0.3F).setHeight(height_Plateau));
		EnumBiome.tundra_plateau.setBiome(				new BiomeTundra(69).setColor(0xD3D1AD).setDisableRain().setTemperatureRainfall(0.0F, 0.02F).setHeight(height_Plateau));
		EnumBiome.valley_tropic.setBiome(				new BiomeValley(70).setColor(0x5DD140).setTemperatureRainfall(0.9F, 0.7F).setHeight(height_Valley));
		EnumBiome.valley_temperate.setBiome(			new BiomeValley(71).setColor(0x99CE8C).setTemperatureRainfall(0.5F, 0.5F).setHeight(height_Valley));
		EnumBiome.valley_frigid.setBiome(				new BiomeValley(72).setColor(0xBBCCB7).setTemperatureRainfall(0.2F, 0.3F).setHeight(height_Valley));
		EnumBiome.desert_subtropics_hill.setBiome(		new BiomeDesert(73, false, true).setColor(0xDF7017).setDisableRain().setTemperatureRainfall(1.8F, 0F).setHeight(height_LowHills));
		EnumBiome.mushroom_island.setBiome(				new BiomeMushroomIsland(74).setColor(0x8F719B).setTemperatureRainfall(0.9F, 0.9F).setHeight(height_LowIslands));
