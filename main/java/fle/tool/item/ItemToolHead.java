...
import static fle.tool.item.ItemTool.materials;
import static fle.tool.item.ItemTool.tagMap;
...
public class ItemToolHead extends ItemSub
{
	...
	public ItemToolHead init()
	{
		addSubItem(1, "rough_stone_axe", "Rough Stone Axe Head",
				new ItemTextureHandler(new String[]{"tools/head/rough_axe_head", "tools/head/rough_axe_rust"}));
		addSubItem(2, "stone_axe", "Stone Axe Head",
				new ItemTextureHandler(new String[]{"tools/head/stone_axe_head", "tools/head/stone_axe_rust"}));
		addSubItem(3, "stone_shovel", "Stone Shovel Head",
				new ItemTextureHandler(new String[]{"tools/head/stone_shovel_head", "tools/head/stone_shovel_rust"}));
		addSubItem(4, "flint_hammer", "Flint Hammer Head",
				new ItemTextureHandler(new String[]{"tools/head/flint_hammer_head", "tools/head/flint_hammer_rust"}));
		addSubItem(5, "stone_hammer", "Stone Hammer Head",
				new ItemTextureHandler(new String[]{"tools/head/stone_hammer_head", "tools/head/stone_hammer_rust"}));
		addSubItem(10, "flint_arrow", "Arrow Point", 
				new ItemTextureHandler("tools/head/flint_arrow_head"));
		addSubItem(11, "stone_sickle", "Stone Sickle Head", 
				new ItemTextureHandler(new String[]{"tools/head/stone_sickle_head", "tools/head/stone_sickle_rust"}));
		addSubItem(12, "stone_spade_hoe", "Stone Spaed-Hoe Head", 
				new ItemTextureHandler(new String[]{"tools/head/spade_hoe_head", "tools/head/spade_hoe_rust"}));
		addSubItem(16, "stone_spinning_disk", "Stone Spinning Disk", 
				new ItemTextureHandler("tools/head/stone_spinning_disk_head"));
		addSubItem(18, "stone_knife", "Stone Knife Head", 
				new ItemTextureHandler(new String[]{"tools/head/stone_knife_head", "tools/head/stone_knife_rust"}));
		addSubItem(101, "metal_axe", "Metal Axe Head",
				new ItemTextureHandler(new String[]{"tools/head/metal_axe_head", "tools/head/metal_axe_rust", "tools/head/metal_axe_mosaic"}));
		addSubItem(102, "metal_pickaxe", "Metal Pickaxe Head",
				new ItemTextureHandler(new String[]{"tools/head/metal_pickaxe_head", "tools/head/metal_pickaxe_rust", "tools/head/metal_pickaxe_mosaic"}));
		addSubItem(103, "metal_hammer", "Metal Hammer Head",
				new ItemTextureHandler(new String[]{"tools/head/metal_hammer_head", "tools/head/metal_hammer_rust", "tools/head/metal_hammer_mosaic"}));
		addSubItem(104, "metal_shovel", "Metal Shovel Head",
				new ItemTextureHandler(new String[]{"tools/head/metal_shovel_head", "tools/head/metal_shovel_rust", "tools/head/metal_shovel_mosaic"}));
		addSubItem(105, "metal_chisel", "Metal Chisel Head",
				new ItemTextureHandler(new String[]{"tools/head/metal_chisel_head", "tools/head/metal_chisel_rust", "tools/head/metal_chisel_mosaic"}));
		addSubItem(106, "metal_bowsaw", "Metal Bowsaw",
				new ItemTextureHandler(new String[]{"tools/head/bowsaw_head", "tools/head/bowsaw_rust", "tools/head/bowsaw_mosaic"}));
		addSubItem(107, "metal_adz", "Metal Adz",
				new ItemTextureHandler(new String[]{"tools/head/metal_adz_head", "tools/head/metal_adz_rust", "tools/head/metal_adz_mosaic"}));
	...
	public final ItemToolHead addSubItem(int aMetaValue, String aTagName, String aLocalized, ItemTextureHandler aLocate)
	{
