...
import fle.core.command.CommandFWM;
...
{	
    ...
    public static final String VERSION = "2.07a";
    public static final int minForge = 1420;
    
    private static final UUID modUUID = new UUID(-7834374458361585156L, -677773943L);
    ...
    private static List<IInitialization> initializations = new ArrayList();
...
//    	tm = new FleTechManager();
    ...
    public void invalidFingerprint(FMLFingerprintViolationEvent event)
    {
        ...
        UUID uuid = new UUID(System.nanoTime(), i1);
        if(modUUID.getLeastSignificantBits() == i1)
        {
    ...
    public void preLoad(FMLPreInitializationEvent event)
    {
    	...
    	FleLog.getLogger().info("Far Land Era start load config and lang resources.");
        try
        {
    	...
    	for(IInitialization initialization : initializations)
    	{
    		initialization.load(event);
    	}
	}
    ...
    @EventHandler
    public void severLoad(FMLServerStartingEvent event)
    {
    	for(IInitialization initialization : initializations)
    	{
    		initialization.load(event);
    	}
    	event.registerServerCommand(new CommandFWM());
    }
	...
	@Override
	public void addInitialization(IInitialization initialization)
	{
