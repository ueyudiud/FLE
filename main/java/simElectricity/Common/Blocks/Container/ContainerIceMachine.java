...
public class ContainerIceMachine extends ContainerBase {
    ...
    public void addCraftingToCrafters(ICrafting listener)
    {
        ...
        listener.sendProgressBarUpdate(this, 0, ((TileIceMachine) tileEntity).progress);
        listener.sendProgressBarUpdate(this, 1, ((TileIceMachine) tileEntity).fluidID);
        listener.sendProgressBarUpdate(this, 2, ((TileIceMachine) tileEntity).amountP);
        listener.sendProgressBarUpdate(this, 3, ((TileIceMachine) tileEntity).isPowered);
    }
